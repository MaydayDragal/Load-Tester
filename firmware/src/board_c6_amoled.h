...
//
// Selected by BOARD_C6_AMOLED — see board_config.h, which picks between this
// and board_s3_lcd35.h. Do not include this header directly.
//
...
//
// This is the ONLY board this firmware has ever been verified on. Every pin
// below follows Waveshare's published ESP32-C6-Touch-AMOLED-1.8 example and has
...
// QSPI pixel clock. The SH8601/CO5300 handle 80 MHz; the synchronous flush
// dominates every redraw, so this roughly halves screen-transition time versus
// Arduino_GFX's 40 MHz default.
...
#define SPK_AMP_EN_VIA_EXPANDER 1
