...
class TestChartView @JvmOverloads constructor(
    ...
    private var samples: List<ResistanceTest.Sample> = emptyList()
    private var resistance = 0f
    private var openCircuitV = 0f

    fun setData(samples: List<ResistanceTest.Sample>, resistanceOhm: Float, openCircuitV: Float) {
    ...
    private fun rAtPoint(s: ResistanceTest.Sample): Float =
